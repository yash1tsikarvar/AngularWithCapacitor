(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    /** @type {?} */
    var pdfjsBleedingEdgeVersion = '2.8.409';
    /**
     * @param {?} folder
     * @return {?}
     */
    ...
    var NgxExtendedPdfViewerComponent = /** @class */ (function () {
            ...
            function () {
                ...
                if (scale) {
                    if (this.zoom === 'auto' || this.zoom === 'page-fit' || this.zoom === 'page-actual' || this.zoom === 'page-width') {
                        ...
                        scale.value = 'custom';
                        try {
                            for (var _b = __values((( /** @type {?} */(scale.options)))), _c = _b.next(); !_c.done; _c = _b.next()) {
                                var option = _c.value;
         ...
         */
            function (event) {
                ...
                var PDFViewerApplication = (( /** @type {?} */(window))).PDFViewerApplication;
                /** @type {?} */
                var desiredCenterY = event.clientY;
                /** @type {?} */
                var previousScale = (( /** @type {?} */(PDFViewerApplication.pdfViewer))).currentScale;
                ...
                /** @type {?} */
                var currentScale = (( /** @type {?} */(PDFViewerApplication.pdfViewer))).currentScale;
                /** @type {?} */
                var scaleCorrectionFactor = currentScale / previousScale - 1;
                /** @type {?} */
                var rect = (( /** @type {?} */(PDFViewerApplication.pdfViewer))).container.getBoundingClientRect();
                /** @type {?} */
                var dy = desiredCenterY - rect.top;
