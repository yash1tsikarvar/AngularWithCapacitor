(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/add/operator/filter'), require('rxjs/add/operator/throttleTime'), require('rxjs/add/observable/fromEvent'), require('rxjs/add/observable/merge'), require('rxjs/Observable'), require('rxjs/Subscription'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'rxjs/add/operator/filter', 'rxjs/add/operator/throttleTime', 'rxjs/add/observable/fromEvent', 'rxjs/add/observable/merge', 'rxjs/Observable', 'rxjs/Subscription', '@angular/core'], factory) :
    (factory((global.ngidle = global.ngidle || {}, global.ngidle.core = global.ngidle.core || {}),global.rxjs_add_operator_filter,global.rxjs_add_operator_throttleTime,global.rxjs_add_observable_fromEvent,global.rxjs_add_observable_merge,global.rxjs_Observable,global.rxjs_Subscription,global.ng.core));
}(this, (function (exports,rxjs_add_operator_filter,rxjs_add_operator_throttleTime,rxjs_add_observable_fromEvent,rxjs_add_observable_merge,rxjs_Observable,rxjs_Subscription,_angular_core) { 'use strict';
...
var EventTargetInterruptSource = (function (_super) {
    ...
    function EventTargetInterruptSource(target, events, options) {
        ...
        _this.target = target;
        _this.events = events;
        _this.eventSubscription = new rxjs_Subscription.Subscription();
        ...
        var fromEvents = events.split(' ').map(function (eventName) { return rxjs_Observable.Observable.fromEvent(target, eventName, opts); });
        _this.eventSrc = rxjs_Observable.Observable.merge.apply(rxjs_Observable.Observable, fromEvents);
