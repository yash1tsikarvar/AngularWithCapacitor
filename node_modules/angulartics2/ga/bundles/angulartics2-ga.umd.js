(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('angulartics2')) :
    typeof define === 'function' && define.amd ? define('angulartics2/ga', ['exports', 'tslib', '@angular/core', 'angulartics2'], factory) :
    (factory((global.angulartics2 = global.angulartics2 || {}, global.angulartics2.ga = {}),global.tslib,global.ng.core,global.angulartics2));
}(this, (function (exports,tslib,core,angulartics2) { 'use strict';
    ...
    var Angulartics2GoogleAnalytics = (function () {
        ...
        Angulartics2GoogleAnalytics.prototype.pageTrack = function (path) {
            if (typeof _gaq !== 'undefined' && _gaq) {
                ...
                try {
                    for (var _a = tslib.__values(this.angulartics2.settings.ga.additionalAccountNames), _b = _a.next(); !_b.done; _b = _a.next()) {
            ...
            if (typeof ga !== 'undefined' && ga) {
                if (this.angulartics2.settings.ga.userId) {
                    ...
                    try {
                        for (var _d = tslib.__values(this.angulartics2.settings.ga.additionalAccountNames), _e = _d.next(); !_e.done; _e = _d.next()) {
                ...
                if (this.angulartics2.settings.ga.anonymizeIp) {
                    ...
                    try {
                        for (var _g = tslib.__values(this.angulartics2.settings.ga.additionalAccountNames), _h = _g.next(); !_h.done; _h = _g.next()) {
                ...
                try {
                    for (var _k = tslib.__values(this.angulartics2.settings.ga.additionalAccountNames), _l = _k.next(); !_l.done; _l = _k.next()) {
