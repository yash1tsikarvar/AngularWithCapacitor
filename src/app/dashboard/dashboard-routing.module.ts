...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'owner-verification', component: OwnerVerificationComponent, canActivate: [OwnerInfoGuard]},
      ...
      {path: 'refund-application', component: RefundApplicationComponent, canActivate: [RefundApplicationGuard]},
      {path: 'profile-success-dashboard', component: ProfileSuccessComponent},
      {path: 'profile-success', component: InfoAfterPayComponent},
      {path: 'personal-reference-verification/:id', component: PersonalReferenceVerificationComponent},
      {path: 'employment-reference-verification/:id', component: EmploymentReferenceVerificationComponent},
      {path: 'landlord-reference-verification/:id', component: LandlordReferenceVerificationComponent},
      {
        path: 'upload/:documentTaskId', component: UploadComponent, canActivate: [UploadDocumentsGuard],
        canDeactivate: [CanDeactivateGuard]
      },
      {path: 'upload-ssn/:documentTaskId', component: UploadSsnComponent},
      {path: 'upload-pet-photo/:documentTaskId', component: UploadPetComponent},
      {
        path: 'upload-vehicle-registration/:documentTaskId',
        component: UploadVehicleRegistrationComponent
      },
      {path: 'id-instructions/:documentTaskId', component: IdInstructionsComponent},
      {path: 'document-selector/:documentTaskId', component: DocumentSelectorComponent},
      {path: 'upload-selector/:documentTaskId', component: UploadSelectorComponent},
      {path: 'upload-mobile/:documentTaskId', component: UploadMobileComponent},
      {path: 'upload-proof-of-income/:proofOfIncome', component: UploadProofOfIncomeComponent},
  ...
  },
  {
    ...
    loadChildren: () => import('./finicity/finicity.module').then(m => m.FinicityModule)
  },
  {
    path: 'finicity-video/:applicantId', component: FinicityVideoComponent
  },
