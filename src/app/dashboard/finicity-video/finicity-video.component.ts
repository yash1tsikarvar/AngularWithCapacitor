...
@Component({
  selector: 'tev-finicity-video',
  templateUrl: './finicity-video.component.html',
  styleUrls: ['./finicity-video.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class FinicityVideoComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(private authService: AuthService,
              ...
              private dialogRef: MatDialogRef<FinicityVideoComponent>,
  ...
  ngOnInit() {
    ...
    this.player = new Player('videoplayer3');
  ...
  openDialog(id: number) {
    localStorage.setItem('video-' + this.applicationId, 'skipped');
